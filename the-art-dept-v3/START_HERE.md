...
- commission detail view with quote, payment status, and draft delivery
...
This adds commission detail fields, quote/payment tracking, draft upload support, and commission order links. It does not delete existing data.
...
4. Artist uploads drafts only after the request shows `paid`.
5. Artist marks the request complete after delivery.
