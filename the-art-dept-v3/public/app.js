...
function renderRequestDetail(request) {
  ...
  return `
    <div class="request-detail">
      ...
      <section class="detail-panel">
        <div class="split-head">
          <div><h3>Final delivery</h3><p class="muted">${paid ? 'Upload the clean final file here after the customer approves the work.' : 'Final clean delivery unlocks after the customer pays through Stripe.'}</p></div>
        ...
        ` : renderEmpty('No final file uploaded yet', paid ? 'Upload the clean final when the commission is ready to deliver.' : 'Payment should be collected before clean files are uploaded.')}
        ${canManage ? `
