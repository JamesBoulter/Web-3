...
async function handleSubmit(event) {
  ...
  if (type === 'portfolio') {
    ...
    if (error && /tags|is_featured|sort_order|column/i.test(error.message || '')) {
    ...
    if (error) throw error;
    showToast(usedFallback ? 'Portfolio uploaded. Run the profile QOL SQL to use tags and featured controls.' : 'Portfolio uploaded.');
    form.reset();
  }
